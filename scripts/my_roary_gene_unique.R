...
TF <- apply(d.f[,group1] != '', 1, sum) == length(group1) & apply(d.f[,group2] == '', 1, sum) == length(group2); sum(TF); 
...
TF <- apply(d.f[,group2] != '', 1, sum) == length(group2) & apply(d.f[,group1] == '', 1, sum) == length(group1); sum(TF); 
